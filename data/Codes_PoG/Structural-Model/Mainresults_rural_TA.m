clear
display('This is the Time Aggregation version of Main Results Rural')
...
%    
%delete('results_TA.csv');
csvwrite('results_TA.csv',estimates);
% check = exist("results_TA.csv");
% if check != 2
%     disp('NO FILE!')
% end
