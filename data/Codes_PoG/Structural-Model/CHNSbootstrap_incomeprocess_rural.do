***************************************************************************************************************
* THIS FILE CALLS THE MATLAB ESTIMATION CODES TO ESTIMATE THE INCOME PROCESS ALONE AND BOOSTRAPS THE 
...
program define progbootinner, rclass
	...
	* RUN THE MATLAB CODE THAT ESTIMATES THE MODEL
	shell "$mymatlab" -wait -nodisplay -nosplash -nodesktop -r < IncomeProcess_boot_rural.m IncomeProcess_boot_rural
...
*************************************************************************** 
	* RURAL SAMPLE
	...
	bootstrap, /*noisily*/ nodrop cluster(case_id) idcluster(bootid) reps(50) seed(200) saving(boot_inc_Rural,replace): progbootouter bootid
	estimates save est_inc_Rural, replace
