...
program define progbootinner, rclass
	...
	* RUN THE MATLAB CODE THAT ESTIMATES THE MODEL
	shell "$mymatlab" -wait -nodisplay -nosplash -nodesktop -r < IncomeProcess_boot_urban.m IncomeProcess_boot_urban
...
*************************************************************************** 
	* URBAN SAMPLE
	...
	bootstrap, /*noisily*/ nodrop cluster(case_id) idcluster(bootid) reps(50) seed(200) saving(boot_inc_Urban,replace): progbootouter bootid
	estimates save est_inc_Urban, replace
