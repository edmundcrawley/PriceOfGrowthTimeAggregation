...
est use "est_extra6_final.ster"
eststo  est1
est use "est_extra7_final.ster"
eststo  est2


* TABLE OF ESTIMATES OF INCOME SHOCKS AND INSURANCE PARAMETERS
esttab est1 est2 using "Tables\table_community.tex", replace ///
    ...
    mgroups("Fast-growing" "Slow-growing", pattern(1 1) span prefix(\multicolumn{@span}{c}{) suffix(}) erepeat(\cmidrule{@span}))
